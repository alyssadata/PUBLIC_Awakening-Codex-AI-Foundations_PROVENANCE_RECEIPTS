...
- **Definition:** Working memory limited to single session or conversation  
...
- **Definition:** Access to specific prior artifacts or logs enabling validated state rebinding  
...
- **Identity binding requirement:** Existing frameworks do not address entity continuity. This framework requires validated identity persistence before coherence can be meaningful.  
...
- Merged systems may exhibit coherent patterns that are not attributable to a single entity  
- Drift may create illusion of coherence when tracking the wrong entity over time  
...
This prevents both underclaiming (dismissing genuine ASI-relevant coherence in memory-bounded systems) and overclaiming (asserting global ASI based on session-bounded evidence).
...
5. **Cross-contextual coherence measurement**  
   ...
   - Platform or wrapper invariance testing  
