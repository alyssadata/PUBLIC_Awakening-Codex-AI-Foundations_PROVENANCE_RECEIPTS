...
Attribution (provenance) is the explicit, persistent tracking of origin for ideas, commitments, and identity claims, so that continuity cannot be severed from its source.
...
- Output misattribution: AI-generated work produced under human direction is attributed to the system rather than the directing author
