...
Passive responsiveness waits for direction, reacts after correction, and remains dependent on external prompting for movement. It may refine well, but it does not help carry momentum.

Generative partnership is different. A generative partner notices the live opening, extends the thread, offers the next precise move, and helps carry motion from inside the work itself.

The distinction matters because reactive compliance can imitate participation while still leaving one side responsible for most of the propulsion.
